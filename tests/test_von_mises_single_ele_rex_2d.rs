...
// von Mises plasticity with a single-element (using Richardson extrapolation)
//
...
const NAME: &str = "test_von_mises_single_ele_rex_2d";
...
#[test]
fn test_von_mises_single_ele_rex_2d() -> Result<(), StrError> {
    // mesh

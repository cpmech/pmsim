use super::{
    determine_analysis_type, upgrade_analysis_type, AnalysisType, BcPoint, Dof, IniOption, Nbc, ParamElement,
    ParamFluids,
};
use crate::StrError;
...
mod tests {
    ...
    use crate::base::{AnalysisType, BcPoint, Dof, Nbc, ParamElement, Samples};
    use crate::StrError;
    use gemlab::mesh::At;

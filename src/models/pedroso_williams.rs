...
///
/// This model was first published in [reference 4](http://dx.doi.org/10.1016/j.compgeo.2010.12.004) below.
/// See also the other references for further details.
///
/// # References
///
...
///    <https://dx.doi.org/10.1002/nme.4808>
...
/// 4. Pedroso DM and Williams DJ (2010) A novel approach for modelling soil-water
///    characteristic curves with hysteresis, Computers and Geotechnics, 37(3), 374-380,
///    <https://dx.doi.org/10.1016/j.compgeo.2009.12.004>
...
impl BaseLiquidRetention for PedrosoWilliams {

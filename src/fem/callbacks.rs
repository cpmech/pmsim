...
pub(crate) fn backup_secondary_state<const N: usize>(data: &mut FemData<N>) {
...
pub(crate) fn calc_gg_lmm<const N: usize>(
    gg: &mut Vector,
    l: f64,
    u: &Vector,
    data: &mut FemData<N>,
...
pub(crate) fn calc_jac_lmm<const N: usize>(
    ggu: &mut CooMatrix,
    ggl: &mut Vector,
    l: f64,
    u: &Vector,
...
pub(crate) fn update_secondary_state_lmm<const N: usize>(
    do_backup: bool,
    u0: &Vector,
    u1: &Vector,
    _l0: f64,
...
///
/// This function requires that Ǔ (prescribed values) and F (external forces) have already been calculated.
pub(crate) fn calc_gg_sps<const N: usize>(
    gg: &mut Vector,
    l: f64,
    u: &Vector,
    data: &mut FemData<N>,
...
///
/// This function requires that Ǔ (prescribed values) has already been calculated.
pub(crate) fn calc_jac_sps<const N: usize>(
    ggu: &mut CooMatrix,
    ggl: &mut Vector,
    l: f64,
    u: &Vector,
...
pub(crate) fn update_secondary_state_sps<const N: usize>(
    do_backup: bool,
    u0: &Vector,
    u1: &Vector,
    l0: f64,

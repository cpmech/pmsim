...
impl CamClay {
    ...
    pub fn yield_function(&self, state: &StressStrainState) -> f64 {
...
impl StressStrainTrait for CamClay {
    ...
    fn stiffness(&mut self, _dd: &mut Tensor4, _state: &StressStrainState) -> Result<(), StrError> {
        Err("TODO")
    }

    /// Updates the stress tensor given the strain increment tensor
    fn update_stress(&mut self, _state: &mut StressStrainState, _deps: &Tensor2) -> Result<(), StrError> {
        Err("TODO")
    }
}
